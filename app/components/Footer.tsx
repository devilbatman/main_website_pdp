...
export default function Footer() {
  ...
  return (
    <footer className="bg-blue-900 text-white border-t border-blue-500/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-white/5 hover:bg-blue-500/20 border border-blue-500/20 rounded-lg flex items-center justify-center transition-colors"
              >
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-blue-300">Kontak</h4>
            <ul className="space-y-2 text-blue-100">
              ...
              <li className="flex items-start">
                ...
                <a href="tel:+6285183064580" className="hover:text-blue-300">
                  +62 851 8306 4580
                </a>
              </li>
              <li className="flex items-start">
